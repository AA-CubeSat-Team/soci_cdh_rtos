###########################################################################
## Makefile generated for Simulink model 'FSW_0123'. 
## 
## Makefile     : FSW_0123.mk
## Generated on : Sun Jan 23 23:48:46 2022
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/FSW_0123.exe
...
COMPILER_COMMAND_FILE     = FSW_0123_comp.rsp
CMD_FILE                  = FSW_0123.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/FSW_0123.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/FSW_0123_ert_rtw -IC:/Users/Nick/DOCUME~1/SOCI -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include
...
DEFINES_STANDARD = -DMODEL=FSW_0123 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/FSW_0123_ert_rtw/FSW_0123.c $(START_DIR)/FSW_0123_ert_rtw/FSW_0123_data.c

MAIN_SRC = $(START_DIR)/FSW_0123_ert_rtw/ert_main.c
...
OBJS = FSW_0123.obj FSW_0123_data.obj
...
%.obj : $(START_DIR)/FSW_0123_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/FSW_0123_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
