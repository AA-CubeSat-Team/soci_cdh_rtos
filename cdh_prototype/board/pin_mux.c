...
- pin_list:
  ...
  - {pin_num: '93', peripheral: LPUART3, signal: RX, pin_signal: GPIO_AD_B0_15, slew_rate: Slow, software_input_on: Disable, open_drain: Disable, speed: MHZ_100,
    drive_strength: R0_7, pull_keeper_select: Keeper, pull_keeper_enable: Disable, pull_up_down_config: no_init, hysteresis_enable: Enable}
  - {pin_num: '94', peripheral: LPUART3, signal: TX, pin_signal: GPIO_AD_B0_14, slew_rate: Slow, software_input_on: Disable, open_drain: Disable, speed: MHZ_100,
    drive_strength: R0_7, pull_keeper_select: Keeper, pull_keeper_enable: Disable, pull_up_down_config: no_init, hysteresis_enable: Enable}
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_14_LPUART3_TX, 0x0100B8U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_15_LPUART3_RX, 0x0100B8U); 
