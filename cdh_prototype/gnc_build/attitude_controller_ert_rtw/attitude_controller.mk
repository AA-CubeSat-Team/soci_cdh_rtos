...
## Generated on : Wed Dec 02 22:23:32 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/attitude_controller
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/attitude_controller
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/attitude_controller_ert_rtw -I/Volumes/GoogleDrive/My\ Drive/Taylor/teaching/AA528/matlab -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=attitude_controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
SRCS = $(START_DIR)/attitude_controller_ert_rtw/attitude_controller.c $(START_DIR)/attitude_controller_ert_rtw/attitude_controller_data.c

MAIN_SRC = $(START_DIR)/attitude_controller_ert_rtw/ert_main.c
...
OBJS = attitude_controller.o attitude_controller_data.o
...
%.o : $(START_DIR)/attitude_controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/attitude_controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
