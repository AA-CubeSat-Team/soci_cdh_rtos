###########################################################################
## Makefile generated for Simulink model 'nothing_test'. 
## 
## Makefile     : nothing_test.mk
## Generated on : Sun May 10 16:06:42 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/nothing_test
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/nothing_test
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/nothing_test_ert_rtw -I/Users/Taylor/SOCI/soci-gnc/Test/Autocoding_tests/components -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=nothing_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
SRCS = $(START_DIR)/nothing_test_ert_rtw/nothing_test.c

MAIN_SRC = $(START_DIR)/nothing_test_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/nothing_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/nothing_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
