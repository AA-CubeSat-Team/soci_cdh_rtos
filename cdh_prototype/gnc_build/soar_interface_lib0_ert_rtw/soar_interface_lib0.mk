###########################################################################
## Makefile generated for Simulink model 'soar_interface_lib0'. 
## 
## Makefile     : soar_interface_lib0.mk
## Generated on : Thu Sep 03 10:35:05 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/soar_interface_lib0
...
PRODUCT_NAME              = soar_interface_lib0
MAKEFILE                  = soar_interface_lib0.mk
COMPUTER                  = MACI64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/soar_interface_lib0
...
DEFINES_STANDARD = -DMODEL=soar_interface_lib0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
OBJS = soar_interface_lib0.o timer.o amd_1.o amd_2.o amd_aat.o amd_control.o amd_defaults.o amd_dump.o amd_global.o amd_info.o amd_order.o amd_post_tree.o amd_postorder.o amd_preprocess.o amd_valid.o cone.o ctrlc.o ecos.o equil.o expcone.o kkt.o ldl.o matlab_main.o preproc.o runecos.o spla.o splamm.o wright_omega.o
...
%.o : $(START_DIR)/soar_interface_lib0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/soar_interface_lib0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
