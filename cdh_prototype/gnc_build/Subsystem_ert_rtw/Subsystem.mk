...
## Generated on : Sun May 10 16:24:11 2020
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Subsystem_ert_rtw -I/Users/Taylor -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Subsystem -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
SRCS = $(START_DIR)/Subsystem_ert_rtw/Subsystem.c $(START_DIR)/Subsystem_ert_rtw/nothing_lib.c
...
OBJS = Subsystem.o nothing_lib.o
