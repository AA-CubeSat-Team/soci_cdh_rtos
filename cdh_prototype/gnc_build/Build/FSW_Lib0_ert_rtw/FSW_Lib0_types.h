...
#ifndef DEFINED_TYPEDEF_FOR_struct_CogvMjrdZBU9tTC712YHzG_
#define DEFINED_TYPEDEF_FOR_struct_CogvMjrdZBU9tTC712YHzG_
...
#ifndef DEFINED_TYPEDEF_FOR_struct_8yxjARLJMopUDqZ7Kuv6Z_
#define DEFINED_TYPEDEF_FOR_struct_8yxjARLJMopUDqZ7Kuv6Z_
...
#ifndef DEFINED_TYPEDEF_FOR_struct_BtF8YKgJREwlEMGBE4IdaB_
#define DEFINED_TYPEDEF_FOR_struct_BtF8YKgJREwlEMGBE4IdaB_
...
typedef struct {
  ...
  RWA allocator;
  struct_CogvMjrdZBU9tTC712YHzG sensors;
  struct_8yxjARLJMopUDqZ7Kuv6Z controllers;
...
/* Custom Type definition for MATLAB Function: '<S412>/SOLVE' */
...
/* Custom Type definition for MATLAB Function: '<S265>/MATLAB Function3' */
...
/* Custom Type definition for MATLAB Function: '<S13>/MATLAB Function' */
#ifndef struct_tag_sqIoFkfYleqi49qIYYpW3MC
#define struct_tag_sqIoFkfYleqi49qIYYpW3MC

struct tag_sqIoFkfYleqi49qIYYpW3MC
{
  real_T A_wheel2body[12];
  real_T inertia[4];
  real_T inv_inertia[4];
...
#endif                                 /*struct_tag_sqIoFkfYleqi49qIYYpW3MC*/

#ifndef typedef_sqIoFkfYleqi49qIYYpW3MC
#define typedef_sqIoFkfYleqi49qIYYpW3MC

typedef struct tag_sqIoFkfYleqi49qIYYpW3MC sqIoFkfYleqi49qIYYpW3MC;

#endif                                 /*typedef_sqIoFkfYleqi49qIYYpW3MC*/

#ifndef struct_tag_sK4myBoPHaBeaMQSSTlYXJH
#define struct_tag_sK4myBoPHaBeaMQSSTlYXJH

struct tag_sK4myBoPHaBeaMQSSTlYXJH
{
  real_T mag_rotate[27];
  real_T mag_offset[9];
  real_T mag_static_range;
...
#endif                                 /*struct_tag_sK4myBoPHaBeaMQSSTlYXJH*/

#ifndef typedef_sK4myBoPHaBeaMQSSTlYXJH
#define typedef_sK4myBoPHaBeaMQSSTlYXJH

typedef struct tag_sK4myBoPHaBeaMQSSTlYXJH sK4myBoPHaBeaMQSSTlYXJH;

#endif                                 /*typedef_sK4myBoPHaBeaMQSSTlYXJH*/
...
#ifndef struct_tag_s4GxYk7097ChquGxmkfjw4C
#define struct_tag_s4GxYk7097ChquGxmkfjw4C

struct tag_s4GxYk7097ChquGxmkfjw4C
{
...
#endif                                 /*struct_tag_s4GxYk7097ChquGxmkfjw4C*/

#ifndef typedef_s4GxYk7097ChquGxmkfjw4C
#define typedef_s4GxYk7097ChquGxmkfjw4C

typedef struct tag_s4GxYk7097ChquGxmkfjw4C s4GxYk7097ChquGxmkfjw4C;

#endif                                 /*typedef_s4GxYk7097ChquGxmkfjw4C*/
...
#ifndef struct_tag_sznTJrTE4IXBCo9TiACRASE
#define struct_tag_sznTJrTE4IXBCo9TiACRASE

struct tag_sznTJrTE4IXBCo9TiACRASE
{
  real_T sample_time_s;
  sdmXjJoaSt2nVqqVAdgX7hG constants;
  sIIsAqBdfUcnX36HXXlqwpE scParams;
  sqIoFkfYleqi49qIYYpW3MC allocator;
  sK4myBoPHaBeaMQSSTlYXJH sensors;
  s4GxYk7097ChquGxmkfjw4C controllers;
  sSQ7EYW1PaOrHAfjwrslAuE estimation;
  s4UGWrK5T4vXCYuUQmez9lD ground_targs[2];
  sZcxJKWLgD1dFbRZRCJVkmD mode_select;
};

#endif                                 /*struct_tag_sznTJrTE4IXBCo9TiACRASE*/

#ifndef typedef_sznTJrTE4IXBCo9TiACRASE
#define typedef_sznTJrTE4IXBCo9TiACRASE

typedef struct tag_sznTJrTE4IXBCo9TiACRASE sznTJrTE4IXBCo9TiACRASE;

#endif                                 /*typedef_sznTJrTE4IXBCo9TiACRASE*/
