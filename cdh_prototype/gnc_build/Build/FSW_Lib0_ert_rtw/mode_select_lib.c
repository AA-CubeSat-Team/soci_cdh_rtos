  ...
  const real_T rtu_RWA_rpm[4], DW_mode_select_lib *localDW)
{
  ...
  /* Outputs for Atomic SubSystem: '<S355>/twonorm' */
  rtb_Sum_kv = twonorm_o(rtu_RWA_rpm);

  /* End of Outputs for SubSystem: '<S355>/twonorm' */
  ...
  /* End of Relay: '<S355>/Relay1' */

  /* Logic: '<S355>/OR' incorporates:
   *  Relay: '<S355>/Relay2'
   */
   ...
   *  MATLAB Function: '<S357>/desat_timer_logic'
   *  Relay: '<S9>/Relay'
   */
  ...
  /* Update for UnitDelay: '<S357>/Unit Delay2' incorporates:
   *  MATLAB Function: '<S357>/desat_timer_logic'
   */
