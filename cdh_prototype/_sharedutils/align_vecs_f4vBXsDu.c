...
void align_vecs_f4vBXsDu(real_T Body1[3], real_T Inertial1[3], real_T Body2[3],
  real_T Inertial2[3], real_T C_cmd[9])
{
  ...
  int32_T i;
  int32_T i_0;
  Body2_0 = norm_EzB1R8di(Body1);
  Inertial2_0 = norm_EzB1R8di(Body2);
  Body1[0] /= Body2_0;
  Body2[0] /= Inertial2_0;
  Body1[1] /= Body2_0;
  Body2[1] /= Inertial2_0;
  ...
  Body2_0 = norm_EzB1R8di(Ztb);
  Inertial2_0 = norm_EzB1R8di(Inertial1);
  Yti_0 = norm_EzB1R8di(Inertial2);
  Ztb[0] /= Body2_0;
