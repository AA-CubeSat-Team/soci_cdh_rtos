...
{
  real_T rtb_Add3_k_idx_0;
  real_T rtb_Add3_k_idx_1;
  real_T rtb_Kp_idx_0;
  real_T rtb_Kp_idx_1;
  real_T rtb_Kp_idx_2;
   ...
   *  Product: '<S259>/Element product'
   */
  rtb_Add3_k_idx_0 = rtb_Switch_g0_idx_2;
   ...
   *  Product: '<S259>/Element product'
   */
  rtb_Add3_k_idx_1 = rtb_Switch_g0_idx_2;
  ...
  if (rtb_MathFunction_d_idx_1 > 0.0) {
    ...
    rtb_Add3_k_idx_0 *= 0.0;
    rtb_Add3_k_idx_1 *= 0.0;
   ...
   *  Product: '<S260>/Divide'
   */
  rtb_Add3_k_idx_0 = rtb_Add3_k_idx_0 / rtb_MathFunction_d_idx_0 *
    rtb_MathFunction_d_idx_1;
  rtb_Add3_k_idx_1 = rtb_Add3_k_idx_1 / rtb_MathFunction_d_idx_0 *
    rtb_MathFunction_d_idx_1;
  ...
  for (i = 0; i < 3; i++) {
    ...
    rty_torque_cmd_body_Nm[i] = (rtCP_Kp_Gain[i + 6] * rtb_Switch_g0_idx_2 +
      (rtCP_Kp_Gain[i + 3] * rtb_Add3_k_idx_1 + rtCP_Kp_Gain[i] *
       rtb_Add3_k_idx_0)) - (rtCP_Kd_Gain[i + 6] * rtu_w_err_radps[2] +
      (rtCP_Kd_Gain[i + 3] * rtu_w_err_radps[1] + rtCP_Kd_Gain[i] *
       rtu_w_err_radps[0]));
  }
}
