...
## 
## Makefile     : FSW_Lib.mk
## Generated on : Tue Mar 29 09:23:05 2022
...
DEFINES_STANDARD = -DMODEL=FSW_Lib -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
CrossProdMatrix_lib.obj : $(START_DIR)/FSW_Lib_ert_rtw/CrossProdMatrix_lib.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
L_inf_allocation_lib.obj : $(START_DIR)/FSW_Lib_ert_rtw/L_inf_allocation_lib.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MEKF_lib.obj : $(START_DIR)/FSW_Lib_ert_rtw/MEKF_lib.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
TRIADActivation_lib.obj : $(START_DIR)/FSW_Lib_ert_rtw/TRIADActivation_lib.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
maggyroProcessing_lib.obj : $(START_DIR)/FSW_Lib_ert_rtw/maggyroProcessing_lib.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
parallel_protection_lib.obj : $(START_DIR)/FSW_Lib_ert_rtw/parallel_protection_lib.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rt_sys_MEKF_lib_37.obj : $(START_DIR)/FSW_Lib_ert_rtw/rt_sys_MEKF_lib_37.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_sys_MEKF_lib_41.obj : $(START_DIR)/FSW_Lib_ert_rtw/rt_sys_MEKF_lib_41.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_sys_MEKF_lib_48.obj : $(START_DIR)/FSW_Lib_ert_rtw/rt_sys_MEKF_lib_48.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
matlab_main.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/matlab_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cone.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/cone.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ctrlc.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/ctrlc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ecos.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/ecos.c
	$(CC) $(CFLAGS) -o "$@" "$<"


equil.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/equil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


expcone.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/expcone.c
	$(CC) $(CFLAGS) -o "$@" "$<"


kkt.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/kkt.c
	$(CC) $(CFLAGS) -o "$@" "$<"


preproc.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/preproc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


spla.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/spla.c
	$(CC) $(CFLAGS) -o "$@" "$<"


splamm.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/splamm.c
	$(CC) $(CFLAGS) -o "$@" "$<"


wright_omega.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/wright_omega.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ldl.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/ldl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_1.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_2.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_aat.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_aat.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_control.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_defaults.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_defaults.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_dump.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_dump.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_global.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_global.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_info.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_info.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_order.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_order.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_post_tree.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_post_tree.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_postorder.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_postorder.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_preprocess.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_preprocess.c
	$(CC) $(CFLAGS) -o "$@" "$<"


amd_valid.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/amd_valid.c
	$(CC) $(CFLAGS) -o "$@" "$<"


runecos.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/runecos.c
	$(CC) $(CFLAGS) -o "$@" "$<"


timer.obj : C:/Users/Nick/Documents/GitHub/soci-gnc/Lib/FSW/soar/include/ecos/src/timer.c
	$(CC) $(CFLAGS) -o "$@" "$<"
