...
EXTERN_C LIBCOVRT_API void covrtInitCvSimulinkInterface(void* instance);
EXTERN_C LIBCOVRT_API void covrtTermCvSimulinkInterface();
EXTERN_C LIBCOVRT_API bool isSimulinkCovrtInitialized(double modelHandle);
