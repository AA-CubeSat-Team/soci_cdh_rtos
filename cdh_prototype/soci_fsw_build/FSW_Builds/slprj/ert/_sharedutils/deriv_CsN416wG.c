...
void deriv_CsN416wG(real_T t, const real_T X_1[190], const real_T u[6], const
                    real_T tspan[10], real_T s, const real_T J[9], real_T DX[190])
{
  ...
  int32_T i_1;
  int32_T s_tmp;
  get_f_vals_Gr0pzuuC(t, &X_1[0], u, tspan, J, f, A, Bdp_dot, Bdm_dot, Zd_dot);
  for (i = 0; i < 30; i++) {
    Bdp_dot[i] *= s;
  }
