...
typedef struct P_IfActionSubsystem14_ P_IfActionSubsystem14;

/* Parameters for system: '<S25>/If Action Subsystem2' */
typedef struct P_IfActionSubsystem2_ P_IfActionSubsystem2;

/* Parameters for system: '<S2>/maggyroProcessing_lib' */
typedef struct P_maggyroProcessing_lib_ P_maggyroProcessing_lib;

/* Parameters for system: '<S115>/parallel_protection_lib' */
typedef struct P_parallel_protection_lib_ P_parallel_protection_lib;

/* Parameters for system: '<S132>/CrossProdMatrix_lib' */
typedef struct P_CrossProdMatrix_lib_ P_CrossProdMatrix_lib;

/* Parameters for system: '<S3>/TRIADActivation_lib' */
typedef struct P_TRIADActivation_lib_ P_TRIADActivation_lib;

/* Parameters for system: '<S188>/Positive Trace' */
typedef struct P_PositiveTrace_ P_PositiveTrace;

/* Parameters for system: '<S188>/Negative Trace' */
typedef struct P_NegativeTrace_ P_NegativeTrace;

/* Parameters for system: '<S191>/If Warning//Error' */
typedef struct P_IfWarningError_ P_IfWarningError;

/* Parameters for system: '<S125>/quat_rectify_lib' */
typedef struct P_quat_rectify_lib_ P_quat_rectify_lib;

/* Parameters for system: '<S124>/CrossProdMatrix_lib' */
typedef struct P_CrossProdMatrix_lib_g_ P_CrossProdMatrix_lib_g;

/* Parameters for system: '<S1>/MEKF_lib' */
typedef struct P_MEKF_lib_ P_MEKF_lib;

/* Parameters for system: '<S236>/null_control_lib1' */
typedef struct P_null_control_lib_ P_null_control_lib;

/* Parameters for system: '<S238>/sunSeek_lib' */
typedef struct P_sunSeek_lib_ P_sunSeek_lib;
...
typedef struct P_quat_err_lib_ P_quat_err_lib;

/* Parameters for system: '<S5>/rwa_allocation_lib' */
typedef struct P_rwa_allocation_lib_ P_rwa_allocation_lib;

/* Parameters for system: '<S288>/target_groundpass_lib' */
typedef struct P_target_groundpass_lib_ P_target_groundpass_lib;

/* Parameters for system: '<S1>/mode_select_lib' */
typedef struct P_mode_select_lib_ P_mode_select_lib;
